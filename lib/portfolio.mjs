...
function allocationConstraintsMet(weights, categories) {
  ...
  if (totals.has("固收") && (totals.get("固收") < 0.25 || totals.get("固收") > 0.6)) return false;
  if (totals.has("A股宽基") && (totals.get("A股宽基") < 0.1 || totals.get("A股宽基") > 0.5)) return false;
  if (totals.has("黄金") && (totals.get("黄金") < 0.05 || totals.get("黄金") > 0.25)) return false;
